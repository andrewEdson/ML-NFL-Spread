...
# -------------------------------
# 8. PREPARE FEATURES FOR CATBOOST (NO ENCODING NEEDED)
# -------------------------------
print("Preparing features for CatBoost...")
# CatBoost can handle categorical features natively, so we don't encode them
...
model_filename = f"cat_boost_nfl_spread_model_{timestamp}_acc{accuracy:.3f}.pkl"
...
metadata_filename = f"cat_boost_metadata_{timestamp}.pkl"
